...
SEED=42
RUN_NAME="ppo_heavyhex_curriculum_v2_$(date +%Y%m%d_%H%M%S)_s${SEED}"
...
# Curriculum inspired by Ali's config (depths 5->10->20, milestones 15%/35%):
#   Stage 1: depth 5   — 1M steps  (10%) — bootstrap basics
#   Stage 2: depth 10  — 3M steps  (30%) — learn routing
#   Stage 3: depth 20  — 6M steps  (60%) — full difficulty (Ali's target depth)
# Total: 10M steps
apptainer exec --nv --writable-tmpfs \
    ...
    --stage1-steps 1000000 \
    --stage2-steps 3000000 \
    --stage3-steps 6000000 \
    --stage1-depth 5 \
    --stage2-depth 10 \
    --stage3-depth 20 \
    \
