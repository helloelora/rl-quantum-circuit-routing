...
SEED=42
RUN_NAME="ppo_heavyhex_curriculum_$(date +%Y%m%d_%H%M%S)_s${SEED}"
...
# 3-stage curriculum on heavy_hex ONLY, increasing depth:
#   Stage 1: depth 5  (easy circuits, ~15 gates) — 1M steps
#   Stage 2: depth 10 (medium, ~40 gates)        — 3M steps
#   Stage 3: depth 16 (full difficulty, ~80 gates) — 6M steps
